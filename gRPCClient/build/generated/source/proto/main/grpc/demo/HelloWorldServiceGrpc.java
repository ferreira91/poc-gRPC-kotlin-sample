...
public final class HelloWorldServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<demo.HelloRequest,
      demo.HelloResponse> getHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "hello",
      requestType = demo.HelloRequest.class,
      responseType = demo.HelloResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<demo.HelloRequest,
      demo.HelloResponse> getHelloMethod() {
    io.grpc.MethodDescriptor<demo.HelloRequest, demo.HelloResponse> getHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getHelloMethod = HelloWorldServiceGrpc.getHelloMethod) == null) {
          HelloWorldServiceGrpc.getHelloMethod = getHelloMethod =
              io.grpc.MethodDescriptor.<demo.HelloRequest, demo.HelloResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "hello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  demo.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  demo.HelloResponse.getDefaultInstance()))
  ...
  public static abstract class HelloWorldServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(demo.HelloRequest request,
        io.grpc.stub.StreamObserver<demo.HelloResponse> responseObserver) {
  ...
  public static final class HelloWorldServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<HelloWorldServiceBlockingStub> {
    ...
    /**
     */
    public demo.HelloResponse hello(demo.HelloRequest request) {
  ...
  public static final class HelloWorldServiceFutureStub extends io.grpc.stub.AbstractFutureStub<HelloWorldServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<demo.HelloResponse> hello(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((demo.HelloRequest) request,
              (io.grpc.stub.StreamObserver<demo.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return demo.HelloProto.getDescriptor();
    }
